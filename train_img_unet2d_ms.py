...
if EVALUATE:
    batch_size = 1
#aera1 = torch.load('/pscratch/sd/p/peterwg/split/aera1.pt') #torch.load('/pscratch/sd/p/peterwg/split/aera1s.pt') #.mean(-1)
SPATIAL_AUG = True
#st()
#aera1 = (aera1*10).astype(int) #(aera1*10).astype(int)#.long()
